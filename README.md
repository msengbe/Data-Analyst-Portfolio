...
| Broadband Accessibility Dashboard Links: [Report](Representation%20and%20Reporting.docx), [Cleaned Churn Data](churn_tidy.csv), [Cleaned FCC Data](fcc_tier_clean.csv), [Broadband Accessibility Dashboard](Broadband.twbx) | Designed a Tableau dashboard to visualize U.S. broadband coverage and highlight gaps in digital equity. | SQL, Python, Tableau |
